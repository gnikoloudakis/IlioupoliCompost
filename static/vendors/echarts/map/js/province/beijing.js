(function (root, factory) {
    ...
    echarts.registerMap('北京', {
        ...
        "features": [{
            ...
            "id": "110102",
            "geometry": {"type": "Polygon", "coordinates": ["@@@GNB@aDABWD@BIE@@AI@BSA@@AB@AGH@@ODABu£GAB@HI@@DCBOAOBIC@NB@BLB@AFF@AB@LX@@DC@BJCBBHAF@VAbE@@BA@CDJDLABA@BDADBFBHADBAF@HHBBC@IJ@VHAhT@BJZ@@GGA@CCABCA@@C"], "encodeOffsets": [[119181, 40920]]},
